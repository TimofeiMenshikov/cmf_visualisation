...
##########################################################################################
#калибровка с доступными таблицами спектров
...
CALIBRATION_PATH =   os.path.join(dir_path, "..", "ao-system",   "ao", "calibration", "2026-02-18", "amplitude_intensity_calibration.csv")
TABLE_SPECTRA_PATH = os.path.join(dir_path, "..", "ao-system",    "ao", "calibration", "2026-02-18", "wv_intens_spectra")
